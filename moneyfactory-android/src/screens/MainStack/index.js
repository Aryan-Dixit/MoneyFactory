...
import VirtualPlanDescription from './HomeScreen/VirtualPlanDescription';
import MyBrokers from './CommonScreens/ProfileStack/MyBrokers';
import NewBroker from './CommonScreens/ProfileStack/NewBroker';
  ...
  return (
    <Stack.Navigator initialRouteName={'BottomTabs'}>
      ...
      <Stack.Group screenOptions={{presentation: 'modal'}}>
        ...
        />
        <Stack.Screen
          name="VirtualPlanDescription"
          component={VirtualPlanDescription}
          options={{headerShown: false}}
        />
      </Stack.Group>
    </Stack.Navigator>
