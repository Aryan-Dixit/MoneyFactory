...
import EquiWealth from '../../../assets/images/Equiweath.png';
import EquiEdge from '../../../assets/images/EquiEdge.png';
...
const HomeScreen = () => {
  ...
  const StarterPlanDescription = () => {
    navigation.navigate('StarterPlanDescription');
  };
  const navigateToVirtualPlanDescription = () => {
    navigation.navigate('VirtualPlanDescription');
  };
      ...
      <ScrollView
        ...
        <View style={[tw('h-full px-5'), styles.container]}>
          ...
          <View style={[tw('flex flex-row justify-between -mt-4')]}>
            <TouchableOpacity
              onPress={StarterPlanDescription}
              style={{
                width: '49%',
                height: 200,
                padding: 0,
              }}>
              <Image source={EquiWealth} style={{width: '100%', height: 187}} />
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                width: '49%',
              ...
              onPress={navigateToVirtualPlanDescription}>
              <Image source={EquiEdge} style={{width: '100%', height: 187}} />
            </TouchableOpacity>
            {/* <Card
          ...
          <View
            style={[
              tw(
                'w-full -mt-8 flex flex-row items-center justify-between p-3 rounded-md ',
              ),
            ...
            <View style={[tw('ml-2')]}>
              <View style={{flexGrow: 1, width: 180, flexDirection: 'column'}}>
                <Text
                  ...
                  Select a Brokers that suits you.
                </Text>
                <Text
                  style={[
                    tw('mt-2'),
              ...
              <TouchableOpacity
                style={[tw('w-36')]}
                onPress={() => {
                  navigation.navigate('MyBrokers');
                }}>
                <Button title="Link Broker" />
              </TouchableOpacity>
            </View>
          </View>
          <View
                ...
                <View>
                  ...
                  <View style={[tw('flex flex-row mt-2 items-start')]}>
                    ...
                    <Text style={[tw('ml-2 -mt-1'), {...styles.card2Subtitle}]}>
                      Link your Demat Account or Open a Free Account{' '}
                    </Text>
                  </View>
                  <View style={[tw('flex mt-1 flex-row items-center')]}>
                    <View
                  ...
                  <View style={[tw('flex flex-row mt-2 items-start')]}>
                    ...
                    />
                    <Text style={[tw('ml-2 -mt-1'), {...styles.card2Subtitle}]}>
                      Get Notified with Investing opportunity on the go
                    </Text>
                  </View>
